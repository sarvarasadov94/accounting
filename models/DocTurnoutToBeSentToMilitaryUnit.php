...
class DocTurnoutToBeSentToMilitaryUnit extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'military_team_number' => 'Military Team Number',
            'military_unit_id' => 'Military Unit ID',
            'disappear_reason' => 'Disappear Reason',
            'return_reason' => 'Return Reason',
            'passed_passport_seria' => 'Passed Passport Seria',
            'passed_passport_number' => 'Passed Passport Number',
            'passed_passport_date' => 'Passed Passport Date',
            'passed_certificate_seria' => 'Passed Certificate Seria',
            'passed_certificate_number' => 'Passed Certificate Number',
            'passed_certificate_date' => 'Passed Certificate Date',
            'returned_passport_seria' => 'Returned Passport Seria',
            'returned_passport_number' => 'Returned Passport Number',
            'returned_passport_date' => 'Returned Passport Date',
            'returned_certificate_of_conscript_sector_seria' => 'Returned Certificate Of Conscript Sector Seria',
            'conscript_id' => 'Conscript ID',
            'returned_certificate_of_conscript_sector_number' => 'Returned Certificate Of Conscript Sector Number',
            'returned_certificate_of_conscript_sector_date' => 'Returned Certificate Of Conscript Sector Date',
        ];
    }
