...
/**
 * DocPassingCommanderTrainingSearch represents the model behind the search form of `app\models\DocPassingCommanderTraining`.
 */
class DocPassingCommanderTrainingSearch extends DocPassingCommanderTraining
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = DocPassingCommanderTraining::find();
